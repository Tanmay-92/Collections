...
public class AddressBookUC7 {
    ...
    public ArrayList<Contacts1>contactList = new ArrayList<>();
    ...
    public void addContactDetails()
    {
        ...
        else 
        {
            ...
            Contacts1 contactofPerson = new Contacts1(firstName, lastName, address, city, state, email, phoneNumber, zip);
    ...
    {
        int flag = 0;
        for(Contacts1 contact: contactList)
        {
    ...
    public boolean checkDuplicate(String fname)
    {
      ...
      public void display() 
      {
  		for (Contacts1 person : contactList)				
